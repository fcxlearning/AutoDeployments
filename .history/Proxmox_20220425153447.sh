...
function SetRepositoryMirror() {
    mirror_list=(
        "deb ${transport_protocol}://ftp.us.debian.org/debian-security ${LSBCodename}-security main contrib non-free"
        "deb ${transport_protocol}://ftp.us.debian.org/debian ${LSBCodename} main contrib non-free"
        "deb ${transport_protocol}://ftp.us.debian.org/debian ${LSBCodename}-backports main contrib non-free"
        "deb ${transport_protocol}://ftp.us.debian.org/debian ${LSBCodename}-updates main contrib non-free"
        "deb-src ${transport_protocol}://ftp.us.debian.org/debian-security ${LSBCodename}-security main contrib non-free"
        "deb-src ${transport_protocol}://ftp.us.debian.org/debian ${LSBCodename} main contrib non-free"
        "deb-src ${transport_protocol}://ftp.us.debian.org/debian ${LSBCodename}-backports main contrib non-free"
        "deb-src ${transport_protocol}://ftp.us.debian.org/debian ${LSBCodename}-updates main contrib non-free"
    )
    proxmox_mirror_list=(
        "# deb ${transport_protocol}://enterprise.proxmox.com/debian/pve ${LSBCodename} pve-enterprise"
        "deb ${transport_protocol}://ftp.us.debian.org/proxmox/debian ${LSBCodename} pve-no-subscription"
        "# deb ${transport_protocol}://ftp.us.debian.org/proxmox/debian ${LSBCodename} pvetest"
        "deb ${transport_protocol}://ftp.us.debian.org/proxmox/debian/ceph-pacific ${LSBCodename} main"
        "# deb ${transport_protocol}://ftp.us.debian.org/proxmox/debian/ceph-pacific ${LSBCodename} test"
    )
